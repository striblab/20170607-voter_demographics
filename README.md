# Star Tribune - Minnesota 2016 Voter Demographics
...
2. Copy files (update path as needed): `mkdir -p ../20170607-voter_demographics/ && rsync -rav ./ ../20170607-voter_demographics/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
